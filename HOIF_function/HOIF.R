...
################################################################################
# Main function using "part" U-statistics definition!
# Computes and return (order-1)'s estimators from 2-th HOIF to order-th HOIF estimator .
# Vector_1: a vector containing the treatment residuals (like (Aa -1) )
# Vector_2: a vector containing the outcome residuals (like (y - b) ,but not (A(y-b))! Here no A-weighted)
# weight_estimation : a vector containing the treatment for Weight-ed Gram matrix ( like A or (1-A) )
...
################################################################################
# Main function using "all" U-statistics definition!
# Computes and return (order-1)'s estimators from 2-th HOIF to 5-th HOIF estimator .
# Vector_1: a vector containing the treatment residuals (like (Aa -1) )
# Vector_2: a vector containing the outcome residuals (like (y - b),here no A-weighted)
# weight_estimation : a vector containing the treatment for Weight-ed Gram matrix ( like A or (1-A) )
# basis: a n*p matrix containing the basis transformations of the confounder.
...
# Computes and return 4 estimators from 2-th HOIF to 5-th U-statistics.
